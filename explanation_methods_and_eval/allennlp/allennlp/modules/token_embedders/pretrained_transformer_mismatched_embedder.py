...
class PretrainedTransformerMismatchedEmbedder(TokenEmbedder):
    ...
    def forward(
        ...
        sequence_embeddings, pooled_embeddings = self._matched_embedder(
            token_ids, wordpiece_mask, type_ids=type_ids, segment_concat_mask=segment_concat_mask
        )

        # span_embeddings: (batch_size, num_orig_tokens, max_span_length, embedding_size)
        # span_mask: (batch_size, num_orig_tokens, max_span_length)
        span_embeddings, span_mask = util.batched_span_select(sequence_embeddings.contiguous(), offsets)
        ...
        return orig_embeddings, pooled_embeddings
