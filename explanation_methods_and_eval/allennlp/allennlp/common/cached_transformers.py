...
def get(
    ...
    if transformer is None:
        if override_weights_file is not None:
            ...
            transformer = AutoModel.from_pretrained(model_name, state_dict=override_weights, cache_dir='cache/')
        else:
            transformer = AutoModel.from_pretrained(model_name, cache_dir='cache/')
