...
class AnchorText(object):
    """bla"""
    def __init__(self, class_names, use_unk_distribution=True, mask_string='UNK'):
        """
        Args:
    ...
    def get_sample_fn(self, text, classifier_fn, onepass=False, use_proba=False):
        ...
        words = np.array(text.split(), dtype='|U80')
